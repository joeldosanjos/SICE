  ...
  <body>
    ...
    <main role="main">
     ...
     <!-- Informações sobre a empresa FOREIGN KEY -->    
          ...
          <h1 class="display-5">Escolha usuário para excluí-lo</h1>
        </div>
      </div>
          ...
          <div class="col-md-8 px-4"><br>
              <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                      ...
                      <select class="inputFields" name="usuario">
                      <option selected disabled>Usuário</option>
                <?php
                $SQL = "SELECT nome, idUsuario, idEmpresa FROM usuario;";
                ...
                while( $item = mysqli_fetch_array( $result ) ) {
                    ...
                    if ($empresaId != "1"){ 
                    echo "<option value='$usuarioId'>$nome</option>";
                    }
                }
                ?>
                      </select>
                  ...
                  <button class="btn btn-danger my-2 my-sm-0" type="submit">Excluir</button>
                  </form>
