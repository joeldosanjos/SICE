...
$idEmpresaEscolhida = $_POST['empresa'];           
$sql = "SELECT idEmpresa, nome, numero, rua, cidade, bairro, cep, complemento FROM empresa WHERE idEmpresa = '$idEmpresaEscolhida'";
$result = mysqli_query($conexao, $sql);
while($dado = mysqli_fetch_array($result)) {
    $empresanome = $dado['nome'];
    $empresanumero = $dado['numero'];
    $empresarua = $dado['rua'];
    $empresacidade = $dado['cidade'];
    $empresabairro = $dado['bairro'];
    $empresacep = $dado['cep'];
    $empresacomplemento = $dado['complemento'];
}       
?>  
...
<html lang="pt-BR">
  <head>
    ...
    <title>Alterar empresa - S.I.C.E.</title>
    <script>  
      function myFunction() {
            var txt;
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-danger">
      <a class="navbar-brand" href="conta_index.php"><img src="logo.png" width="140" height="50" alt=""></a>
    ...
    <main role="main">
     ...
     <!-- Informações sobre a empresa FOREIGN KEY -->    
          ...
          <h1 class="display-5">Informações da empresa</h1>
        </div>
      </div>
        ...
        <div class="col-md-3"></div>
          <div class="col-md-8 px-4">
            <div class="card-block px-3"><br>
              <h4 class="card-title"><?php echo $empresanome ?></h4><br>
              <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                    <tbody>
                      <form method="post" action="php/alterarempresa.php">
                      <tr>
                        <td class="font-weight-bold">Cidade</td>
                        <td><input type="text" value="<?php echo $empresacidade; ?>" name="cidade"></td>
                      </tr>
                      <tr>
                        <td class="font-weight-bold">CEP</td>
                        <td><input type="text" value="<?php echo $empresacep; ?>" name="cep"></td>
                      </tr>
                      <tr>
                        <td class="font-weight-bold">Bairro</td>
                        <td><input type="text" value="<?php echo $empresabairro; ?>" name="bairro"></td>
                      </tr>
                      <tr>
                          <td class="font-weight-bold">Rua</td>
                        <td><input type="text" value="<?php echo $empresarua; ?>" name="rua"></td>
                      </tr>
                      <tr>
                          <td class="font-weight-bold">Número</td>
                        <td><input type="text" value="<?php echo $empresanumero; ?>" name="numero"></td>
                      </tr>
                      <tr>
                          <td class="font-weight-bold">Complemento</td>
                        <td><input type="text" value="<?php echo $empresacomplemento; ?>" name="complemento"></td>
                      </tr>
                        <input type="hidden" value="<?php echo $idEmpresaEscolhida; ?>" name="idEmpresaEscolhida">
                    </tbody>
                  </table>
                  <input type="submit" value="Alterar" class="btn btn-warning"></a>
