  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="jumbotron">
        <div class="container">
            <br><br><br>
          <h1 class="display-5">Listar extintores</h1>
        </div>
      </div>
      ...
      <div class="container">
          ...
          $sql = "SELECT selo_inmetro, tipo_extintor, DATE_FORMAT(ult_recarga,'%d/%m/%Y'), DATE_FORMAT(vencimento,'%d/%m/%Y') FROM extintor WHERE idUsuario = '$idUsuario'";
         ...
         echo"<tbody>
              <tr>
                <form method='get' action='ver_extintor.php'>
