      ...
      <div class="row">
        <div class="col-md-4">
          <div class="text-center">
            ...
            <img src="../img/iconeAdicionarExtintor.png" width="200" height="216">
            <p><a class="btn btn-secondary" href="cadastro_extintor.php" role="button">Adicionar &raquo;</a></p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="text-center">
            <h2>Listar extintores / fichas</h2><br>
            <p><img src="../img/iconeListarExtintorFicha.png" width="200" height="200"></p>
            <p><a class="btn btn-secondary" href="listar_extintor.php" role="button">Listar extintor &raquo;</a>
              <a class="btn btn-secondary" href="listar_ficha.php" role="button">Listar ficha &raquo;</a>
            </p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="text-center">
            ...
            <p><img src="../img/iconeGerarRelatorio.png" width="200" height="200"></p>
            <p><a class="btn btn-secondary" href="cadastro_ficha.php" role="button">Gerar &raquo;</a></p>
          </div>
        </div>
      </div>
