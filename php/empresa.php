...
$sql = "SELECT empresa.nome, empresa.numero, empresa.rua, empresa.cidade, empresa.bairro, empresa.cep, empresa.complemento FROM usuario, empresa WHERE (usuario.idEmpresa = empresa.idEmpresa) AND usuario.idUsuario = '$idUsuario'";
...
if (
  isset($_SESSION['cidade']) || isset($_SESSION['cep']) || isset($_SESSION['bairro']) || isset($_SESSION['rua']) || isset($_SESSION['numero']) ||
  isset($_SESSION['complemento'])
) {

  $empresacidade = $_SESSION['cidade'];
  $empresacep = $_SESSION['cep'];
  $empresabairro = $_SESSION['bairro'];
  $empresarua = $_SESSION['rua'];
  $empresanumero = $_SESSION['numero'];
  $empresacomplemento = $_SESSION['complemento'];
}
?>
...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-danger">
    <a class="navbar-brand" href="conta_index.php"><img src="img/logo.png" width="140" height="50" alt=""></a>
